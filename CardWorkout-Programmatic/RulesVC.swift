...
class RulesVC: UIViewController {
    ...
    func configureRulesLabel(){
        ...
        rulesLabel.text = "The value of  each card number represents the exercise you do \n\nJ= 11, Q = 12. K = 13, A = 14."
    ...
    func configureExerciseLabel(){
        ...
        NSLayoutConstraint.activate([
            exerciseLabel.topAnchor.constraint(equalTo: rulesLabel.bottomAnchor, constant: 90),
